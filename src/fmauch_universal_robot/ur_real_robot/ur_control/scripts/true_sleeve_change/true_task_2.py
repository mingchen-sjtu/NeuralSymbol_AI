...
from VAE_client_task2 import VAE_SendImg
...
class TSTPlanner:
    ...
    def start(self,  pose):
        self.plc_control.set_return_zero_in()
...
if __name__ == '__main__':
    ...
    try:
        ...
        pose_target.position.x = 0.016
        pose_target.position.y = 0.276
        # pose_target.position.y = 0.548
        # pose_target.position.y = 0.643
        # pose_target.position.y = 0.862
