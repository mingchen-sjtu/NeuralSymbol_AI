...
def set_return_zero():
    ...
    modclient.setOutput(register,value,0)
    # time.sleep(3)
    print("VW324:",modclient.readRegisters(162,1))
    time.sleep(6)
    set_sleeve_angle(17100)
    set_sleeve_rotation()
...
if __name__=="__main__":
    ...
    #     print("angle:",modclient.readRegisters(150,1))
    #     print("rotation:",modclient.readRegisters(152,1))
    #     set_sleeve_rotation()
    #     print("rotation:",modclient.readRegisters(152,1))      
    #     time.sleep(5)
