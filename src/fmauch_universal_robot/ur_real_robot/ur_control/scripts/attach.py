...
class Attacher(object):
  ...
  def add_box(self, timeout=4):
    ...
    if (sleeve_type=="M6_bolt" or sleeve_type=="M8_bolt"or sleeve_type=="M10_bolt"):
      ...
      box_pose.pose.position.z = 0.034 # slightly above the end effector
      box_pose.pose.position.x = 0
      box_pose.pose.position.y = 0
      scene.add_cylinder(box_name, box_pose, 0.068,0.008)
      ...
      box_pose.pose.orientation.z = qtn[2]
      box_pose.pose.orientation.w = qtn[3]
      box_pose.pose.position.z = 0.024 # slightly above the end effector
      box_pose.pose.position.x = 0
      box_pose.pose.position.y = 0
      scene.add_cylinder(box_name, box_pose, 0.048,0.008)
  ...
  def attach_bolt2end(self,bolt):
    ...
    # Link them
    rospy.loginfo("Attaching end and "+bolt_type)
    req = AttachRequest()
    req.model_name_1 = "robot"
    req.link_name_1 = "wrist_3_link"
