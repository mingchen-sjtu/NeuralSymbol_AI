...
class SimClearObstacle(SimBase):
    ...
    def action(self, all_info, pre_result_dict,kalman,yolo):
        ...
        while not kalman.finished:
            ...
            s=kalman.itr_sum
            # if 'm_bolt' in detect_ret[1].keys() or 'cross_bolt' in detect_ret[1].keys() or 'star_bolt' in detect_ret[1].keys() or 'hexagon_bolt' in detect_ret[1].keys():
            #     circlesbox=[]
            #     if 'm_bolt' in detect_ret[1].keys():
            #         print('m_bolt success')
            #         circlesbox.extend(detect_ret[1]["m_bolt"])
            #     if 'cross_bolt' in detect_ret[1].keys():
            #         print('cross_bolt success')
            #         circlesbox.extend(detect_ret[1]["cross_bolt"])
            #     if 'star_bolt_bolt' in detect_ret[1].keys():
            #         print('star_bolt success')
            #         circlesbox.extend(detect_ret[1]["star_bolt_bolt"])
            #     if 'hexagon_bolt' in detect_ret[1].keys():
            #         print('hexagon_bolt success')
            #         circlesbox.extend(detect_ret[1]["hexagon_bolt_bolt"])
