...
class TestAimTarget(TestBase):
    def get_tgt_pose_in_world_frame(self,all_info):
        ...
        tgt_pose_in_real_frame.position.z = -0.5
    ...
    def action(self, all_info, pre_result_dict,kalman):
        ...
        if 'circles' in detect_ret.keys():
            ...
            print(bolt_pose)
            bp= tf.transformations.euler_from_quaternion([bolt_pose.orientation.x,bolt_pose.orientation.y,bolt_pose.orientation.z,bolt_pose.orientation.w])
            print(bp)
